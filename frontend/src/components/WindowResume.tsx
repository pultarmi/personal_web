...
export default function WindowResume() {
	return (
		<div className={styles.WindowResume} id="resume-div">
			{/*<h1>About me:</h1>*/}
			<TimelineBox topic="Quantasoft" style={{marginLeft: "400px"}}>
			...
			<TimelineBox topic="Center for Machine Perception" style={{marginLeft: "300px"}}>
			...
			<TimelineBox topic="Tampere University" style={{marginLeft: "400px"}}>
				● Improved the HardNet local feature descriptor by introducing a new deep convolutional architecture. <br/>
			</TimelineBox>
			<TimelineBox topic="Blindspot Solutions" style={{marginLeft: "500px"}}>
